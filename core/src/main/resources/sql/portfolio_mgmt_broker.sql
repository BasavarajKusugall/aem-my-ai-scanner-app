...
CREATE TABLE `broker` (
  ...
  UNIQUE KEY `ux_broker_code` (`code`)
...
INSERT INTO `broker` VALUES (1,'UPSTOX','Upstox Securities','https://api.upstox.com','ACTIVE','2025-08-19 16:05:25'),(2,'ZERODHA','Zerodha Kite','https://api.kite.trade','ACTIVE','2025-08-19 17:12:55');

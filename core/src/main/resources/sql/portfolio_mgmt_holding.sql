...
CREATE TABLE `holding` (
  ...
  `user_broker_account_id` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`holding_id`),
  UNIQUE KEY `ux_holding` (`account_id`,`instrument_id`),
  KEY `ix_hold_instr` (`instrument_id`),
  CONSTRAINT `fk_holding_account` FOREIGN KEY (`account_id`) REFERENCES `user_broker_account` (`account_id`),
